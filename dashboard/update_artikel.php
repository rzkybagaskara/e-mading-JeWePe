          ...
          <div class="container-fluid box">
            ...
            <form action = "../dashboard/actions/update_artikel_action.php" method = "POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="judul_artikel" value="<?php echo htmlspecialchars($row['judul']); ?>">
              </div>

              <!-- Isi Artikel -->
              <div class="form-group">
                  <label for="exampleFormControlSelect1">Isi Artikel</label>
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isi_artikel"><?php echo htmlspecialchars($row['isi']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="uploader" value="<?php echo htmlspecialchars($row['uploader']); ?>">
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="status_artikel" id="radioButtonDraft" <?php echo ($row['status_artikel'] == 'Draft') ? 'checked' : ''; ?> value= "Draft">
                      <label class="form-check-label" for="radioButtonDraft">
                          Draft
                      </label>
                  </div>
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="status_artikel" id="radioButtonPublish" <?php echo ($row['status_artikel'] == 'Publish') ? 'checked' : ''; ?> value= "Publish">
