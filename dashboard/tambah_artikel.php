            ...
            <form action = "../dashboard/actions/tambah_artikel_action.php" method = "POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_artikel" id="radioButtonDraft" value = "Draft">
                        <label class="form-check-label" for="radioButtonDraft">
                          Draft
                        </label>
                  </div>
                  <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_artikel" id="radioButtonPublish" value = "Publish">
